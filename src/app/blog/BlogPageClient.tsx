...
const categoryColors: Record<string, string> = {
  ...
  "Sosyal Medya": "bg-pink-500/10 text-pink-400 border-pink-500/20",
  "Web Geliştirme": "bg-blue-500/10 text-blue-400 border-blue-500/20",
  "İçerik Pazarlama": "bg-orange-500/10 text-orange-400 border-orange-500/20",
};
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-muted">
              SEO, dijital pazarlama ve web teknolojileri hakkında güncel
                      ...
                      <div className="absolute bottom-4 left-4">
                        <span
                          className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium ${
                            categoryColors[post.category] || "bg-white/10 text-white border-white/20"
                          }`}
                        >
                          <Tag size={10} />
                          {post.category}
